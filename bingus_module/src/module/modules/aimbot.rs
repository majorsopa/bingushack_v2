...
fn tick(_aimbot: &mut Aimbot, _env: JNIEnv, _mappings_manager: &MappingsManager) {
...
// rn it's only linear
fn next_smooth_rotation(_pitch_and_yaw: [f32; 2], _goal: [f32; 2], _interval: [f32; 2]) -> [f32; 2] {
    let _ret: [f32; 2] = [0.0, 0.0];
    todo!()
}
